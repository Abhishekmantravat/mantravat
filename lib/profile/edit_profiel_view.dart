...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar( title: Text('mantravat'),
        centerTitle: true,
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (BuildContext context) => task()));
            },
          ),
        ],
      ),
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              buildTextField("Education", '', false),
              buildTextField('Skill', "", false),
              buildTextField("Current Location", "", false),
